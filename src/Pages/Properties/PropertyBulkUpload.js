...
const PropertyBulkUpload = () => {
    ...
    const submitBulkImportForm = (e) => {
        ...
        setUploadErrors([])
        postApiCall('user/property/uploadProperty', formData).then((response) => {
        ...
        <h3> Property Bulk Upload</h3> 
            ...
            {permission.hasOwnProperty('moduleAccress') && !permission.moduleAccress ?
              ...
              :
                ...
                { permission?.disabledCreate ? null : (
                            <div className="row">
                                ...
                                <div className="col-md-3 mt-0">
                                    <div className="form-group"> 
                                        {isUploading ? <button className="btn btn-warning btn-circle-lg" disabled={true}>Uploading</button> : <button className="btn btn-primary btn-circle-lg">Upload</button>}
                                    </div>
                                </div>
                            </div>)}
                        </form>
                        ...
                        {
                            uploadErrors != undefined && uploadErrors.map((error, index) => {
                                return <>
